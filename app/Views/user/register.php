...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('/templogin/images/bg-01.png');">
			...
			<form class="login100-form validate-form flex-sb flex-w" action="/user/register" method="post">
    ...
    <div class="wrap-input100 validate-input" data-validate="Confirmation email is required">
        <input class="input100" type="email" name="confirm_email" required>
        <span class="focus-input100"></span>
    </div>
    ...
    <div class="w-full text-center p-t-55">
        ...
        <a href="/user/login" class="txt2 bo1">
            Sign In
        </a>
    </div>
</form>
