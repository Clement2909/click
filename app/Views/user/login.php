    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('/templogin/images/bg-01.png');">
            <div class="wrap-login100">
                ...
                <form class="login100-form validate-form" action="/user/verificationlogin" method="post">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input class="input100" type="text" name="username" value="andry@gmail.com">
                        <span class="focus-input100" data-placeholder="&#xf207;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <input class="input100" type="password" name="pass" value="andry">
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>
                    ...
                    <div class="container-login100-form-btn m-t-17">
                        <a href="/user/register" class="login100-form-btn">Register</a>
                    </div>
